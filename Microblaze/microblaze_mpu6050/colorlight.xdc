...
## Board LED D2
# IO_L17P_T2_16 - i9+_LED_D2
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports led_D2]; 
...
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports n_btn]; #IO_L2P_T0_34 - P2_4
set_property -dict {PACKAGE_PIN V2 IOSTANDARD LVCMOS33} [get_ports led[7]]; #IO_L2N_T0_34 - P2_5
set_property -dict {PACKAGE_PIN W1 IOSTANDARD LVCMOS33} [get_ports led[6]]; #IO_L5P_T0_34 - P2_6
set_property -dict {PACKAGE_PIN AA1 IOSTANDARD LVCMOS33} [get_ports led[5]]; #IO_L7P_T1_34 - P2_7
set_property -dict {PACKAGE_PIN W2 IOSTANDARD LVCMOS33} [get_ports led[4]]; #IO_L4P_T0_34 - P2_9
set_property -dict {PACKAGE_PIN AB2 IOSTANDARD LVCMOS33} [get_ports led[3]]; #IO_L8N_T1_34 - P2_12
set_property -dict {PACKAGE_PIN AB3 IOSTANDARD LVCMOS33} [get_ports led[2]]; #IO_L8P_T1_34 - P2_13
set_property -dict {PACKAGE_PIN W4 IOSTANDARD LVCMOS33} [get_ports led[1]]; #IO_L12N_T1_MRCC_34 - P2_14
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports led[0]]; #IO_L18P_T2_34 - P2_15
...
## Header P4
set_property -dict {PACKAGE_PIN AB21 IOSTANDARD LVCMOS33} [get_ports iic_rtl_0_scl_io]; #IO_L10P_T1_D14_14 - P4_3
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports iic_rtl_0_sda_io]; #IO_L18P_T2_A12_D28_14 - P4_4
